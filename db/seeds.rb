...
martinluron      = User.new(firs_name: "martin", last_name: "luron", age: 22, city: "rezé", description: "", sports: {"football" => "confirmé", "basketball" => "intermédiaire"} , email: "martin.luron@gmail.com", password: "mar123")
...
louisemaryse     = User.new(firs_name: "martin", last_name: "luron", age: 19, city: "rezé", description: "Coucou ! J'adore l'escalade et la fitness", sports: {"basketball" => "intermédiaire", "escalade" => "débutant"} , email: "louise.maryse@gmail.com", password: "lou123")
...
paulinelebeau        = User.new(firs_name: "pauline", last_name: "lebeau", age: 22, city: "nantes", description: "", sports: {"cyclisme" => "intermédiaire", "fitness" => "confirmé"} , email: "labellepopo@gmail.com", password: "pau123")
...
amandinepayet        = User.new(firs_name: "amandine", last_name: "payet", age: 30, city: "nantes", description: "Coucou, j'ai découvert l'escalade il y a peu et j'adore ! Mais je trouve ça plus sympa de le faire avec d'autres. J'ai aussi fait du basketball en club pendant plusieurs années, une vrai terreur sous la racket.", sports: {"escalade" => "intermédiaire", "basketball" => "confirmé", "football" => "débutant"} , email: "apayet@gmail.com", password: "ama123")
...
maximejader        = User.new(firs_name: "maxime", last_name: "jader", age: 42, city: "carquefou", description: "", sports: {"rugby" => "confirmé", "basketball" => "débutant"} , email: "maxime.jader@laposte.net", password: "max123")
...
azizsubra          = User.new(firs_name: "aziz", last_name: "subra", age: 18, city: "orvault", description: "", sports: {"tennis" => "intermédiaire", "running" => "confirmé", "basketball" => "intermédiaire"} , email: "a.subra@hotmail.com", password: "azi123")
...
nicolasvillenaud        = User.new(firs_name: "nicolas", last_name: "villenaud", age: 32, city: "nantes", description: "Nouveau dans la région, je souhaite rencontrer des sportifs comme moi, pour grader la forme et faire de nouvelles connaissances. J'ai fait un peu de basketball en club, du running le weekend quand le temps le permet et la fonte ne me fais pas peur !", sports: {"fitness" => "confirmé", "running" => "intermédiaire", "basketball" => "intermédiaire"} , email: "n.villenaud@gmail.com", password: "nic123")
...
footing10km = Event.create!(name: "Footing 10km", description: "Salut tout le monde je vais courir tous les mardis et je me sens un peu seul ! Si des gens veulent me rejoindre inscrivez-vous !", location: "Parc de Procé, Nantes", starts_at: "2020-12-15 07:00", sport: "running", expected_level: "confirmé", expected_participants_count: , owner: jessicaletellec)
jogging10km = Event.create!(name: "Jogging 12km", description: "Hello les buddies, j'en ai un peu marre de courir seul sur les bords de l'erdre. L'endroit est magnifique, autant le partagé.", location: "Pont de la trotière, Nantes", starts_at: "2020-12-13 09:00", sport: "running", expected_level: "intermédiaire", expected_participants_count: , owner: davidtravailleur)
coursedebutant = Event.create!(name: "Course à pied débutant", description: "Bonjour les buddies, récemment divorcée je suis en train de me refaire une santé pour plaire à nouveau aux hommes. Si vous voulez me rejoindre à petite foulées inscrivez vous je suis ouverte aux rencontres ", location: "Iles de Nantes, Nantes", starts_at: "2020-12-17 14:00", sport: "running", expected_level: "débutant", expected_participants_count: , owner: catherineduchaud)
runningnantes = Event.create!(name: "Running ile de Nantes", description: "Salut la communauté, je prépare un trail et pour ça je fais uncircuit sympathique sur l'île de Nantes.Je cherche des buddies pour courir et gagner en motivation.", location: "Iles de Nantes, Nantes", starts_at: "2020-12-13 08:00", sport: "running", expected_level: "confirmé", expected_participants_count: , owner: adeleperrin)
semimarathon = Event.create!(name: "Semi-marathon", description: "Salut les sportifs ! Je cherche des gens chauds pour courir un semi samedi matin ! L'objectif est de le terminer, ce n'est pas une course de vitesse ! Venez nombreux !", location: "Parc de la Gaudinière, Orvault", starts_at: "2020-12-19 10:00", sport: "running", expected_level: "intermédiaire, confirmé", expected_participants_count: , owner: joaogomes)
trail30km = Event.create!(name: "Trail 30km", description: "Hello les warriors ! Je suis à la recherche de runners pour m'accompagner dans un circuit en pleine forêt, dna sle but de préparer ma prochaine course, attention le niveau sera rude !", location: "Carquefou", starts_at: "2020-12-19 09:00", sport: "running", expected_level: "intermédiaire, confirmé", expected_participants_count: , owner: marienguyen)
fitnesspartenaire = Event.create!(name: "Cherche un partenaire de fitness", description: "Bonjour à tous, voulant garder la forme et ne sachant pas trop les bonne pratiques je cherche quelqu'un pour faire du fitness avec moi dans la bonne humeur et partager ses connaissances", location: "Beaulieu Fitness, Nantes", starts_at: "2020-12-14 21:00", sport: "fitness", expected_level: "intermédiaire, confirmé", expected_participants_count: 1, owner: paulinelebeau)
streetworkout = Event.create!(name: "Street workout", description: "Bonjour tout le monde. Je lance les invitations à me rejoindre pour une séance de circuit training en pleine air d'environ 2h, je compte sur vous pour me rejoindre et bruler pleins de calories.", location: "Parc du grand bloterau", starts_at: "2020-12-20 09:00", sport: "fitness", expected_level: "débutant, intermédiaire", expected_participants_count: , owner: joaogomes)
...
coursedebutantfinished = Event.create!(name: "Course à pied débutant", description: "Bonjour les buddies, récemment divorcée je suis en train de me refaire une santé pour plaire à nouveau aux hommes. Si vous voulez me rejoindre à petite foulées inscrivez vous je suis ouverte aux rencontres ", location: "Iles de Nantes, Nantes", starts_at: "2020-11-30 14:00", sport: "running", expected_level: "débutant", expected_participants_count: , owner: catherineduchaud)
