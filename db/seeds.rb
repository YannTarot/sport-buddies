...
basketindoor4v4 = Event.create!(name: "Match de basket indoor 4v4", description: "Yo ! J'ai un créneau dans une salle pour faire du basket indoor sur un super parquet, on est déjà 3, il manque plus que toi pour venir compléter le match.", location: "Gymnase Jean Jahan, Nantes", starts_at: "2020-12-21 20:00", sport: "basketball", expected_level: "confirmé", expected_participants_count: 5, owner_id: maximejader.id)
